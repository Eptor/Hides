...
class Ui_encrypt_menu(object):
    def setupUi(self, encrypt_menu):
        ...
        self.search_folder.setIcon(icon)
        ...
        self.new_location_label.setGeometry(QtCore.QRect(350, 80, 221, 16))
    ...
    def retranslateUi(self, encrypt_menu):
        ...
        self.new_location_label.setText(
            _translate("encrypt_menu", "Directorio de destion")
        )
